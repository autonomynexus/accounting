...
// ============================================================================
// FEC Record — Article A.47 A-1 du Livre des Procédures Fiscales
// 18 mandatory fields for Fichier des Écritures Comptables
// ============================================================================
...
export type FecSnapshot = {
  ...
  readonly siren: string;
  readonly closingDate: string; // ISO date
