...
import { add, EUR, isZero, monetary, subtract } from "monetary";
import { BANK_ACCOUNT, VAT_COLLECTED_ACCOUNT, getVatDeductibleAccount, } from "../chart-of-accounts.js";
 ...
 */
export const validateDoubleEntry = (lines) => Effect.gen(function* () {
    if (lines.length < 2) {
 ...
 */
export function buildJournalLinesFromTransaction(params) {
