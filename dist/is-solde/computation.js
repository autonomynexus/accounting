...
import { IS_TAUX_REDUIT, IS_TAUX_NORMAL, IS_TAUX_REDUIT_PLAFOND, IS_CA_PLAFOND_TAUX_REDUIT, IS_CONTRIBUTION_SOCIALE_SEUIL, IS_CONTRIBUTION_SOCIALE_TAUX, IS_CONTRIBUTION_SOCIALE_ABATTEMENT, } from "./models.js";
 ...
 */
export function computeIS(input) {
 ...
 */
export function computeAcompteDates(exerciceDateDebut, exerciceDateFin) {
 ...
 */
export function computeAcomptes(isPrecedent, exerciceDateDebut, exerciceDateFin) {
...
// ============================================================================
export function applyDeficitReportEnAvant(resultatFiscal, deficitsAnterieurs) {
